...
class Model(object):
  def __init__(self, num_classes, batch_size, network_size, subset_ratio, num_features, dropout = 1, l2 = 0, l0 = 0, rho=0, stored_weights=None):
    ...
    self.l2_loss = tf.reduce_mean(tf.squared_difference(tf.one_hot(self.y_input, depth = num_classes), self.logits))
    ...
    try:
      ...
      # print(self.y_input_distil.shape)
      # print(self.y_input_distil)
      # self.y_input_distil = tf.argmax(self.y_input_distil, axis=1)
